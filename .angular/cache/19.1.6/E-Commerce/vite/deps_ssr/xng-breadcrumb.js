...
function BreadcrumbComponent_ng_container_2_span_3_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
function BreadcrumbComponent_ng_container_2_span_3_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtext(1);
    ɵɵelementContainerEnd();
...
function BreadcrumbComponent_ng_container_2_span_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "span", 10);
    ɵɵtemplate(1, BreadcrumbComponent_ng_container_2_span_3_ng_container_1_Template, 1, 0, "ng-container", 8)(2, BreadcrumbComponent_ng_container_2_span_3_ng_container_2_Template, 2, 1, "ng-container", 9);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
...
function BreadcrumbComponent_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(2, BreadcrumbComponent_ng_container_2_a_2_Template, 3, 19, "a", 4)(3, BreadcrumbComponent_ng_container_2_span_3_Template, 3, 10, "span", 5);
    ɵɵelementEnd();
...
var BreadcrumbItemDirective = class _BreadcrumbItemDirective {
  static {
...
var BreadcrumbService = class _BreadcrumbService {
  constructor(activatedRoute, router) {
    ...
    this.breadcrumbs = new import_rxjs.BehaviorSubject([]);
  ...
  detectRouteChanges() {
    ...
    this.router.events.pipe((0, import_operators.filter)((event) => event instanceof GuardsCheckEnd)).subscribe((event) => {
...
var BreadcrumbComponent = class _BreadcrumbComponent {
  ...
  ngOnInit() {
    this.breadcrumbs$ = this.breadcrumbService.breadcrumbs$.pipe((0, import_rxjs.map)((breadcrumbs) => {
